...
For examples on how to use the package, see [here](https://htmlpreview.github.io/?https://github.com/kbansak/powerLATE/blob/master/aux/powerLATE_Examples.html)
